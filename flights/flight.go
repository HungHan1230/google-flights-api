...
func (s *Session) doRequestFlights(ctx context.Context, args Args) (*http.Response, error) {
	...
	url := "https://www.google.com/_/FlightsFrontendUi/data/travel.frontend.flights.FlightsFrontendService/GetShoppingResults?f.sid=-1558180700798845550&bl=boq_travel-frontend-flights-ui_20250122.02_p0&hl=und&soc-app=162&soc-platform=1&soc-device=1&_reqid=78598&rt=c"
