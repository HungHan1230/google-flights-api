...
func (s *Session) doRequestLocation(ctx context.Context, city string, lang language.Tag) (*http.Response, error) {
	...
	requestURL := "https://www.google.com/_/FlightsFrontendUi/data/batchexecute?rpcids=H028ib&source-path=%2Ftravel%2Fflights%2Fsearch&f.sid=-548636065650453651&bl=boq_travel-frontend-flights-ui_20250129.02_p0" +
		"&hl=" + lang.String() +
		"&soc-app=162&soc-platform=1&soc-device=1&_reqid=981606&rt=c"
