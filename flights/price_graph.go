...
func (s *Session) doRequestPriceGraph(ctx context.Context, args PriceGraphArgs) (*http.Response, error) {
	...
	url := "https://www.google.com/_/FlightsFrontendUi/data/travel.frontend.flights.FlightsFrontendService/GetCalendarGraph?f.sid=-548636065650453651&bl=boq_travel-frontend-flights-ui_20250129.02_p0&hl=zh-TW&soc-app=162&soc-platform=1&soc-device=1&_reqid=781606&rt=c"
